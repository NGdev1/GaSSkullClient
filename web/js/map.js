...
function initMap() {
    ...
    map.addListener('click', function (e) {
        ...
        infoWindow = new google.maps.InfoWindow({
            content: '<button onclick="addLocation' + e.latLng.toString() + '" class="button-center-oval" style="margin: auto">Добавить точку</button>' +
            'Координаты:' +
            '<br/>' + e.latLng
        });
        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                var infoWindow = new google.maps.InfoWindow({
                    ...
                    '<button onclick="addLocation(' + pos.lat + ", " + pos.lng + ')" class="button-center-oval" style="margin: auto">Добавить точку</button>' +
                    'Координаты:' +
                    '<br/>' + pos.lat + " " + pos.lng +
                    '<br/>'
                });
